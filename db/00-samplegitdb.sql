...
--
-- Host: 127.0.0.1    Database: hadithdb
-- ------------------------------------------------------
...
--
-- Table structure for table `AppErrorReport`
--
...
--
-- Dumping data for table `AppErrorReport`
--
...
--
-- Table structure for table `ArabicHadithTable`
--
...
CREATE TABLE `ArabicHadithTable` (
  `arabicURN` int(11) NOT NULL DEFAULT '0',
  ...
  `hadithNumber` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bookName` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `babName` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `hadithText` mediumtext COLLATE utf8_unicode_ci,
  `annotations` text COLLATE utf8_unicode_ci,
  `bookID` decimal(3,1) NOT NULL,
  `grade1` text COLLATE utf8_unicode_ci,
  `ourHadithNumber` int(11) NOT NULL,
  `matchingEnglishURN` int(11) NOT NULL,
...
--
-- Dumping data for table `ArabicHadithTable`
--
...
--
-- Table structure for table `BanglaHadithTable`
--
...
CREATE TABLE `BanglaHadithTable` (
  `banglaURN` int(11) NOT NULL DEFAULT '0',
  `collection` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `volumeNumber` int(11) NOT NULL,
  `bookNumber` int(11) NOT NULL,
  `bookName` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `babNumber` int(11) DEFAULT NULL,
  `babName` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `hadithNumber` int(11) NOT NULL,
  `hadithSanad` text COLLATE utf8_unicode_ci NOT NULL,
  `hadithText` text COLLATE utf8_unicode_ci,
  `bookID` decimal(3,1) NOT NULL,
  `grade` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `comments` text COLLATE utf8_unicode_ci NOT NULL,
  `ourHadithNumber` int(11) NOT NULL,
  `matchingArabicURN` int(11) NOT NULL,
  `last_updated` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `BanglaHadithTable`
--
...
--
-- Table structure for table `ChapterData`
--
...
CREATE TABLE `ChapterData` (
  ...
  `arabicBabNumber` varchar(21) COLLATE utf8_unicode_ci NOT NULL,
  `englishBabNumber` varchar(21) COLLATE utf8_unicode_ci NOT NULL,
  `englishBabName` text COLLATE utf8_unicode_ci NOT NULL,
  `arabicBabName` text COLLATE utf8_unicode_ci NOT NULL,
  `arabicIntro` text COLLATE utf8_unicode_ci,
  `englishIntro` text COLLATE utf8_unicode_ci,
  `arabicEnding` text COLLATE utf8_unicode_ci,
  `englishEnding` text COLLATE utf8_unicode_ci,
...
--
-- Dumping data for table `ChapterData`
--
...
CREATE TABLE `Collections` (
  ...
  `showTranslationProgress` tinyint(4) NOT NULL DEFAULT '0',
  `reference_template` tinytext COLLATE utf8_unicode_ci,
  ...
  `hasBooksBoolean` tinyint(1) DEFAULT NULL,
  `hasChaptersBoolean` tinyint(1) DEFAULT NULL,
  `hasVolumesBoolean` tinyint(1) DEFAULT NULL,
...
--
-- Table structure for table `EnglishHadithTable`
--
...
CREATE TABLE `EnglishHadithTable` (
  `englishURN` int(11) NOT NULL DEFAULT '0',
  `collection` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `volumeNumber` int(11) NOT NULL,
  `bookNumber` int(11) NOT NULL,
  `bookName` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `bookID` decimal(3,1) NOT NULL,
  `grade1` text COLLATE utf8_unicode_ci,
  `grade2` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `comments` text COLLATE utf8_unicode_ci NOT NULL,
  `ourHadithNumber` int(11) NOT NULL,
  `matchingArabicURN` int(11) NOT NULL,
  `last_updated` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `EnglishHadithTable`
--
...
--
-- Table structure for table `HadithTable`
--
...
CREATE TABLE `HadithTable` (
  `collection` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `bookNumber` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `babID` decimal(6,2) NOT NULL,
  `englishBabNumber` varchar(21) COLLATE utf8_unicode_ci DEFAULT NULL,
  `arabicBabNumber` varchar(21) COLLATE utf8_unicode_ci DEFAULT NULL,
  `hadithNumber` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `ourHadithNumber` int(11) NOT NULL,
  `arabicURN` int(11) NOT NULL,
  `arabicBabName` text COLLATE utf8_unicode_ci,
  `arabicText` text COLLATE utf8_unicode_ci,
  `arabicgrade1` varchar(2000) COLLATE utf8_unicode_ci NOT NULL,
  `englishURN` int(11) NOT NULL,
  `englishBabName` text COLLATE utf8_unicode_ci,
  `englishText` text COLLATE utf8_unicode_ci,
  `englishgrade1` varchar(2000) COLLATE utf8_unicode_ci NOT NULL,
  `last_updated` timestamp NULL DEFAULT NULL,
  `xrefs` varchar(1000) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`arabicURN`),
  UNIQUE KEY `arabicURN` (`arabicURN`),
...
--
-- Dumping data for table `HadithTable`
--
...
--
-- Table structure for table `IndonesianHadithTable`
--
...
CREATE TABLE `IndonesianHadithTable` (
  `indonesianURN` int(11) NOT NULL DEFAULT '0',
  `collection` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `volumeNumber` int(11) NOT NULL,
  `bookNumber` int(11) NOT NULL,
  `bookName` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `babName` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `hadithNumber` int(11) NOT NULL,
  `hadithText` varchar(20000) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bookID` decimal(3,1) NOT NULL,
  `grade` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `comments` text COLLATE utf8_unicode_ci NOT NULL,
  `ourHadithNumber` int(11) NOT NULL,
...
--
-- Dumping data for table `IndonesianHadithTable`
--
...
CREATE TABLE `Narrators` (
  ...
  `RawiRank` smallint(6) NOT NULL,
  `DateOfBirth` tinytext COLLATE utf8_unicode_ci,
  `BaladEkama` text COLLATE utf8_unicode_ci,
  `BaladWafa` text COLLATE utf8_unicode_ci,
  `Bokhary` tinyint(1) NOT NULL,
  `Moslem` tinyint(1) NOT NULL,
  `DeathYear` tinytext COLLATE utf8_unicode_ci,
  `Karaba` text COLLATE utf8_unicode_ci,
  `Konya` tinytext COLLATE utf8_unicode_ci,
  `Lakab` tinytext COLLATE utf8_unicode_ci,
  `Mawaaly` tinytext COLLATE utf8_unicode_ci,
  `Mazhab` tinytext COLLATE utf8_unicode_ci,
  `Name` text COLLATE utf8_unicode_ci NOT NULL,
  `Badeel` text COLLATE utf8_unicode_ci,
  `Nasab` text COLLATE utf8_unicode_ci,
  `Shohra` text COLLATE utf8_unicode_ci NOT NULL,
  `San3a` text COLLATE utf8_unicode_ci,
  `Tabaka` smallint(6) NOT NULL,
  `Wasf` tinytext COLLATE utf8_unicode_ci,
  `WasfRotba` tinytext COLLATE utf8_unicode_ci,
  `Rotba` int(11) NOT NULL,
  `Tadleese` tinyint(1) NOT NULL,
  `E5telat` tinyint(1) NOT NULL,
  `CommonName` text COLLATE utf8_unicode_ci,
  `Marweyaat` int(11) NOT NULL,
  `IsMale` tinyint(1) NOT NULL,
  `DisplayID` int(11) NOT NULL,
  `MarweyaatCountSymbol` tinytext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `UrduHadithTable`
--
...
CREATE TABLE `UrduHadithTable` (
  `urduURN` int(11) NOT NULL DEFAULT '0',
  `collection` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `volumeNumber` int(11) NOT NULL,
  `bookNumber` int(11) NOT NULL,
  `bookName` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `UrduHadithTable`
--
...
CREATE TABLE `matchtable` (
  ...
  `englishURN` int(11) NOT NULL,
  `ourHadithNumber` int(11) NOT NULL,
  `indonesianURN` int(11) DEFAULT NULL,
  `urduURN` int(11) NOT NULL,
  `banglaURN` int(11) DEFAULT NULL,
...
-- Dump completed on 2024-11-18 23:04:43
